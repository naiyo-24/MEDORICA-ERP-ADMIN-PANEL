...
class ASMCreateEditMonthTripPlanCard extends StatefulWidget {
  const ASMCreateEditMonthTripPlanCard({
    super.key,
    required this.title,
  ...
  @override
  State<ASMCreateEditMonthTripPlanCard> createState() =>
      _ASMCreateEditMonthTripPlanCardState();
}

class _ASMCreateEditMonthTripPlanCardState
    extends State<ASMCreateEditMonthTripPlanCard> {
